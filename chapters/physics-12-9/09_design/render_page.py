# -*- coding: utf-8 -*-
"""Stage 9 render script for physics-12-9 (Ray Optics and Optical
Instruments): reads 08_tag/structured.hi.json, hand-templates it onto the
house style (solutions-chapter-1.html's exemplar), concretely modeled on
chapters/physics-12-8/09_design/render_page.py (itself modeled on
physics-12-7/physics-12-6's own render scripts), and writes
...
CH = os.path.join(ROOT, "chapters", "physics-12-9")

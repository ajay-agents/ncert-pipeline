...
:::example{number="3.1" kind="example" id="ex_3.1" topic="Average and instantaneous rate from concentration data" simplified="True" corrections_applied="3"}
#### Example 3.1
...
We find the difference in concentration over different intervals of time. Dividing $\Delta[\mathrm{R}]$ by $\Delta t$ gives the average rate (Table 3.1).
...
We can also find it graphically. Draw a tangent at time t on either curve (concentration of R or P vs time t) and calculate its slope (Fig. 3.1). So in problem 3.1, we can find $r_{\text {inst }}$ at 600s, for example, by plotting the concentration of butyl chloride against time. We draw a tangent that touches the curve at $t=600 \mathrm{~s}$ (Fig. 3.2).
...
:::example{number="3.2" kind="example" id="ex_3.2" topic="Average rate of N2O5 decomposition in different time units" simplified="True" corrections_applied="1"}
#### Example 3.2
...
:::example{number="3.4" kind="example" id="ex_3.4" topic="Reaction order from rate constant units" simplified="True"}
#### Example 3.4
...
:::solution
The unit of a second order rate constant is $\mathrm{L} \mathrm{mol}^{-1} \mathrm{~s}^{-1}$. So $k=2.3 \times 10^{-5} \mathrm{~L} \mathrm{~mol}^{-1} \mathrm{~s}^{-1}$ represents a second order reaction.
:::
...
:::solution
The unit of a first order rate constant is $\mathrm{s}^{-1}$. So $k=3 \times 10^{-4} \mathrm{~s}^{-1}$ represents a first order reaction.
:::
...
:::example{number="3.6" kind="example" id="ex_3.6" topic="Rate constant from total pressure data" simplified="True"}
#### Example 3.6
...
:::solution{label="Solution"}
:::concept{label="Given"}
Let the pressure of $\mathrm{N}_{2} \mathrm{O}_{5}(\mathrm{g})$ decrease by 2x atm. Two moles of $\mathrm{N}_{2} \mathrm{O}_{5}$ decompose to give two moles of $\mathrm{N}_{2} \mathrm{O}_{4}(\mathrm{g})$ and one mole of $\mathrm{O}_{2}(\mathrm{g})$. So the pressure of $\mathrm{N}_{2} \mathrm{O}_{4}(\mathrm{g})$ increases by 2x atm, and the pressure of $\mathrm{O}_{2}(\mathrm{g})$ increases by x atm.
...
:::example{number="3.8" kind="example" id="ex_3.8" topic="Proof: 99.9% completion time versus half-life" simplified="True"}
#### Example 3.8
...
:::solution{label="Solution"}
:::step{n="1"}
When the reaction is completed, $99.9 \%,[\mathrm{R}]_{\mathrm{n}}=[\mathrm{R}]_{0}-0.999[\mathrm{R}]_{0}$
...
:::question{number="3.7" kind="exercise" id="q_3.7" topic="Temperature dependence of rate constant" simplified="True"}
#### Question 3.7
...
:::solution{label="Solution"}
For most chemical reactions, the rate constant nearly doubles when the temperature rises by 10°.

The Arrhenius equation expresses this temperature effect quantitatively:
...
:::question{number="3.10" kind="exercise" id="q_3.10" topic="Order determination from data" simplified="True"}
#### Question 3.10
...
:::question{number="3.11" kind="exercise" id="q_3.11" topic="Rate law from kinetic data" simplified="True"}
#### Question 3.11
...
:::question{number="3.12" kind="exercise" id="q_3.12" topic="Fill in rate table" simplified="True"}
#### Question 3.12
...
From experiment III, we get Rate
...
:::question{number="3.15" kind="exercise" id="q_3.15" topic="N2O5 decomposition kinetics" simplified="True"}
#### Question 3.15
...
:::solution{label="Solution"}
:::concept{label="Given"}
(ii) Time corresponding to the concentration, $\frac{1.630 \times 10^{2}}{2} \mathrm{~mol} \mathrm{~L}^{-1}=81.5 \mathrm{molL}^{-1}$, is the half life.
:::
...
:::note{type="tip" label="Textbook variance"}
...
:::question{number="3.22" kind="exercise" id="q_3.22" topic="Arrhenius plot and prediction" simplified="True" corrections_applied="4"}
#### Question 3.22
...
:::question{number="3.26" kind="exercise" id="q_3.26" topic="Activation energy from Arrhenius form" simplified="True"}
#### Question 3.26
...
:::question{number="3.27" kind="exercise" id="q_3.27" topic="Ea and temperature from rate equation" simplified="True"}
#### Question 3.27
...
:::question{number="3.28" kind="exercise" id="q_3.28" topic="Temperature from Arrhenius equation" simplified="True"}
#### Question 3.28
...
:::question{number="3.29" kind="exercise" id="q_3.29" topic="k and Ea from completion times" simplified="True"}
#### Question 3.29
...
:::step{label="Substitute"}
Again, from the Arrhenius equation, we get
...
:::question{number="3.30" kind="exercise" id="q_3.30" topic="Activation energy from rate quadrupling" simplified="True" corrections_applied="1"}
#### Question 3.30
...
:::question{number="3.4" kind="additional_exercise" id="it_3.4" topic="Second order rate effect" simplified="True"}
...
:::step{label="Substitute"}
Let $[\mathrm{X}]=a \mathrm{~mol} \mathrm{~L}^{-1}$. Then equation (1) becomes:
Rate $_{1}=k .(a)^{2}$
...
If the concentration of X is increased to three times, $[\mathrm{X}]=3 a \mathrm{~mol} \mathrm{~L}^{-1}$
...
:::step{label="Conclusion"}
So the rate of formation increases by 9 times.
:::
:::
...
:::question{number="3.5" kind="additional_exercise" id="it_3.5" topic="First order half-life time" simplified="True"}
...
:::question{number="3.7" kind="additional_exercise" id="it_3.7" topic="Temperature effect on rate constant" simplified="True"}
...
:::solution{label="Solution"}
The rate constant of a reaction nearly doubles with a $10^{\circ}$ rise in temperature. The exact dependence of reaction rate on temperature is given by the Arrhenius equation:
...
:::question{number="3.8" kind="additional_exercise" id="it_3.8" topic="Activation energy calculation" simplified="True"}
...
We also know the rate of the reaction doubles when temperature increases by 10°.
So let us take $k_{1}=k$ and $k_{2}=2 k$.

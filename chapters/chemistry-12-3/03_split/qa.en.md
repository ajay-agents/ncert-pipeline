...
(iii)
| t(s) | $10^{2} \times\left[\mathrm{N}_{2} \mathrm{O}_{5}\right] / \mathrm{mol} \mathrm{L}^{-1}$ | $\boldsymbol{\operatorname { l o g }}\left[\mathrm{N}_{2} \mathrm{O}_{5}\right]$ |
| :--- | :--- | :--- |
| 0 | 1.63 | - 1.79 |
| 400 | 1.36 | - 1.87 |
| 800 | 1.14 | - 1.94 |
...
:::question{number="3.20" kind="exercise" id="q_3.20" topic="Rate constant from pressure data"}
#### Question 3.20
...
$$
\left(\mathrm{CH}_{3}\right)_{2} \mathrm{CHN}=\mathrm{NCH}\left(\mathrm{CH}_{3}\right)_{2(g)} \longrightarrow \mathrm{N}_{2(g)}+\mathrm{C}_{6} \mathrm{H}_{1+(g)}
$$
...
:::question{number="3.22" kind="exercise" id="q_3.22" topic="Arrhenius plot and prediction"}
#### Question 3.22
...
| $\ln k \longrightarrow$ | $3.66 \times 10^{-3}$ | $3.41 \times 10^{-3}$ | $3.19 \times 10^{-3}$ | $3.0 \times 10^{-3}$ | $2.83 \times 10^{-3}$ |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
:::question{number="3.30" kind="exercise" id="q_3.30" topic="Activation energy from rate quadrupling"}
#### Question 3.30
...
$$
\begin{aligned}
& \text { Therefore, } \log \frac{4 k_{1}}{k_{2}}=\frac{E_{a}}{2.303 \times 8.314}\left(\frac{313-2}{293 \times 3}\right. \\
& \begin{aligned}

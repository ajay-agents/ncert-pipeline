...
:::example{number="6.1" kind="example" id="ex_6.1" topic="गैल्वेनोमीटर विक्षेप बढ़ाने के उपाय" verified="True" simplified="True"}
#### उदाहरण 6.1
...
:::solution
धारामापी को टॉर्च में उपयोग किए जाने वाले छोटे बल्ब से बदल देंगे। दोनों कुंडलियों के बीच सापेक्ष गति से बल्ब क्षणिक अवधि के लिए चमकेगा जो प्रेरित धारा के उत्पन्न होने का द्योतक है।
:::note{type="tip" label="सुझाव"}
...
:::example{number="6.2" kind="example" id="ex_6.2" topic="वर्गाकार लूप में क्षेत्र परिवर्तन से प्रेरित वि.वा. बल" verified="True" simplified="True"}
#### उदाहरण 6.2
...
:::note{type="recall" label="याद रखें"}
...
:::example{number="6.3" kind="example" id="ex_6.3" topic="घूर्णन कुंडली में पृथ्वी क्षेत्र से प्रेरित वि.वा. बल" verified="True" simplified="True"}
#### उदाहरण 6.3
...
:::note{type="caution" label="सावधानी"}
...
:::example{number="6.4" kind="example" id="ex_6.4" topic="लेंज़ नियम से लूपों में प्रेरित धारा की दिशा" verified="True" simplified="True"}
#### उदाहरण 6.4
...
:::example{number="6.5" kind="example" id="ex_6.5" topic="फ्लक्स अपरिवर्तन की स्थितियाँ एवं लेंज़ नियम" verified="True" simplified="True"}
#### उदाहरण 6.5
...
:::example{number="6.6" kind="example" id="ex_6.6" topic="घूर्णन छड़ में गतिक वि.वा. बल की दो विधियाँ" verified="True" simplified="True"}
#### उदाहरण 6.6
...
:::example{number="6.7" kind="example" id="ex_6.7" topic="घूर्णन पहिये में पृथ्वी क्षेत्र से प्रेरित वि.वा. बल" verified="True" simplified="True"}
#### उदाहरण 6.7
...
:::example{number="6.8" kind="example" id="ex_6.8" topic="समकेंद्री कुंडलियों का अन्योन्य प्रेरकत्व" verified="True" simplified="True"}
#### उदाहरण 6.8
...
:::solution{label="हल"}
:::concept{label="जानकारी"}
माना कि बाह्य वृत्ताकार कुंडली में से $I_{2}$ धारा प्रवाहित होती है। कुंडली के केन्द्र पर चुंबकीय क्षेत्र है $B_{2}=\mu_{0} I_{2} / 2 r_{2}$ । क्योंकि दूसरी समाक्षी कुंडली की त्रिज्या अत्यंत अल्प है, उसके अनुप्रस्थ काट क्षेत्रफल पर $B_{2}$ का मान स्थिर माना जा सकता है।
:::
...
:::example{number="6.9" kind="example" id="ex_6.9" topic="परिनालिका में संचित चुंबकीय ऊर्जा" verified="True" simplified="True"}
#### उदाहरण 6.9
...
:::example{number="6.10" kind="example" id="ex_6.10" topic="साइकिल पैडल जनित्र की अधिकतम वोल्टता" verified="True" simplified="True"}
#### उदाहरण 6.10
...
:::solution{label="हल"}
:::concept{label="जानकारी"}
यहाँ $v=0.5 \mathrm{~Hz} ; N=100, A=0.1 \mathrm{~m}^{2}$ तथा $B=0.01 \mathrm{~T}$ ।
:::

:::formula{label="मुख्य सूत्र"}
समीकरण (6.19) लगाने पर
$$
\begin{aligned}
...
:::question{number="6.1" kind="exercise" id="q_6.1" topic="चित्रों में प्रेरित धारा की दिशा" verified="True" simplified="True" corrections_applied="1"}
#### प्रश्न 6.1
...
:::step{label="मान रखो"}
(a) यहाँ दक्षिणी धुव कुण्डली की ओर गतिमान है। लेन्ज के नियमानुसार यह सिरा उतरी धुव बन जाता है, ताकि दक्षिणी ध्रुव की गति प्रतिकर्षण द्वारा रुक सके। अतः धारा की दिशा ऊर्जा की सुईयों के अनुरूप है, अर्थात् धारा $p$ से $q$ की दिशा में है।
(b) कुण्डली $pq$ में $q$ सिरे पर $S$ धुव $q$ सिरे की ओर गतिमान है। अतः यह दक्षिणी धुव की तरह कार्य करता है। धारा की दिशा वामावर्त है, अर्थात् $p$ से $q$ की ओर। दक्षिणी धुव दूर की ओर गतिमान है, अतः यह सिरा दक्षिणी धुव की भाँति कार्य करता है, ताकि गति का विरोघ हो सके। $xy$ कुण्डली में $S$ धुव प्रेरित होता है (लेन्ज के नियमानुसार) तथा धारा की दिशा $x$ से $y$ की ओर है।
(c) जब कुन्जी को बन्द किया जाता है, तब कुण्डली में धारा के मान में वृद्धि होती है। अतः चुम्बकीय फ्लक्स और चुम्बकीय क्षेत्र भी बढ़ता है। मैक्सवेल के दाएँ हाथ के नियमानुसार चुम्बकीय क्षेत्र की दिशा दक्षिणावर्त है। अतः समीपवर्ती कुण्डली में प्रेरित धारा की दिशा इस प्रकार होती है कि यह चुम्बकीय क्षेत्र को कम करने का प्रयास करे। समीपवर्ती कुण्डली में धारा वामावर्त दिशा में होती है। मैक्सवेल के दाएँ हाथ के नियमानुसार प्रेरित धारा की दिशा दक्षिणावर्ती है, अर्थात xyz तल में।
(d) रियोस्टेट समायोजन को परिवर्तित करने पर धारा भी परिवर्तित होती है। मैक्सवेल के दाएँ हाथ के नियमानुसार, चुम्बकीय क्षेत्र की दिशा बायीं ओर है। बायीं ओर की कुण्डली में प्रेरित धारा की दिशा इस प्रकार है कि इसके द्वारा उत्पन्न चुम्बकीय क्षेत्र दायीं दिशा में हो। अत: धारा की दिशा बायीं कुण्डली में घड़ी की सुईयों के विपरीत दिशा में है।
(e) जैसे ही कुन्जी को विमुक्त करते हैं, घड़ी की सुईंयों के विपरीत दिशा में बहने वाली धारा घटती है। अतः प्रेरित धारा इस प्रकार उत्पन्न होती है कि बायीं ओर की कुण्डली के कारण उत्पन्न चुम्बकीय क्षेत्र बढ़े। अतः दायीं ओर की कुण्डली के कारण चुम्बकीय क्षेत्र दायीं दिशा में होना चाहिए, तथा प्रेरित धारा घड़ी की सुईयों के विपरीत दिशा में है।
:::

:::step{label="निष्कर्ष"}
(f) धारावाही तार के कारण चुम्बकीय बल रेखाएँ लूप के समतल में हैं। अतः लूप में कोई प्रेरित धारा नहीं होगी, क्योंकि लूप में $\phi=0$ है।
:::
:::

:::

:::question{number="6.2" kind="exercise" id="q_6.2" topic="आकार परिवर्तन से प्रेरित धारा की दिशा" verified="True" simplified="True"}
#### प्रश्न 6.2
...
:::solution{label="हल"}
(a) यहाँ पर चुम्बकीय क्षेत्र की दिशा समतल के लम्बवत अन्दर की ओर है। यदि अनियमित आकृति का तार वृत्तीय आकृति में बदल जाता है, तब इसका क्षेत्रफल बढ़ जाता है, क्योंकि वृत्तीय लूप का क्षेत्रफल अन्य आकृति से अधिक होता है। अतः चुम्बकीय फ्लक्स भी बढ़ता है। अब उत्पन्न प्रेरित धारा की दिशा इस प्रकार है कि वह चुम्बकीय क्षेत्र को कम करे। अर्थात् धारा घड़ी की सूईयों के विपरीत दिशा में है।
...
:::question{number="6.3" kind="exercise" id="q_6.3" topic="परिनालिका के अंदर लूप में प्रेरित वि.वा. बल" verified="True" simplified="True"}
#### प्रश्न 6.3
...
:::question{number="6.4" kind="exercise" id="q_6.4" topic="कटे आयताकार लूप में प्रेरित वि.वा. बल" verified="True" simplified="True"}
#### प्रश्न 6.4
...
:::question{number="6.5" kind="exercise" id="q_6.5" topic="घूर्णन छड़ में प्रेरित वि.वा. बल" verified="True" simplified="True"}
#### प्रश्न 6.5
...
:::question{number="6.6" kind="exercise" id="q_6.6" topic="गिरते तार में पृथ्वी क्षेत्र से प्रेरित वि.वा. बल" verified="True" simplified="True"}
#### प्रश्न 6.6
...
:::question{number="6.7" kind="exercise" id="q_6.7" topic="धारा परिवर्तन से स्वप्रेरकत्व का आकलन" verified="True" simplified="True"}
#### प्रश्न 6.7
...
:::question{number="6.8" kind="exercise" id="q_6.8" topic="अन्योन्य प्रेरकत्व से फ्लक्स बंधता परिवर्तन" verified="True" simplified="True"}
#### प्रश्न 6.8

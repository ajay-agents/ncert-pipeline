...
:::note{type="tip" label="Alternative method"}
Alternatively,
...
:::note{type="tip" label="Alternative units"}
...
:::step{label="Substitute"}
charge = current $\times$ time $=1.5 \mathrm{~A} \times 600 \mathrm{~s}=900 \mathrm{C}$
:::
...
:::formula{label="Cathode reaction"}
$$
...
:::formula{label="Overall reaction"}
$$

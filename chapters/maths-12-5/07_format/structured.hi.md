...
स्पष्टतया $x=0$ पर फलन परिभाषित है और $f(0)=0$ है।
:::

:::step{n="1"}
बिंदु $x=0$ पर $f$ की बाएँ पक्ष की सीमा
...
:::example{number="7" kind="example" id="ex_5.7" topic="Continuity of the modulus function on all reals" corrections_applied="2"}
#### उदाहरण 7
...
चूँकि $\lim _{x \rightarrow c} f(x)=f(c)$, इसलिए $f$ सभी ऋणात्मक वास्तविक संख्याओं के लिए संतत है।
:::

:::step{n="2"}
अब मान लीजिए कि $c$ एक वास्तविक संख्या इस प्रकार है कि $c>0$ है। अतएव $f(c)=c$ साथ ही
...
:::concept{label="अनंत की संकल्पना"}
...
(जिसे इस प्रकार पढ़ा जाता है: $0$ पर $f(x)$ के बाएँ पक्ष की सीमा ऋणात्मक अनंत है।) यहाँ हम इस बात पर बल देना चाहते हैं कि $-\infty$ एक वास्तविक संख्या नहीं है अतएव $0$ पर $f$ के बाएँ पक्ष की सीमा का अस्तित्व नहीं है (वास्तविक संख्याओं के रूप में)।
:::

आकृति $5.3$ का आलेख उपर्युक्त तथ्यों का ज्यामितीय निरूपण है।
...
इसलिए $\lim _{x \rightarrow c} f(x)=\lim _{x \rightarrow c}(x-2)=c-2=f(c)$ है। अतएव उन सभी बिंदुओं पर जहाँ $x>1$ है, $f$ संतत है।
:::
...
:::example{number="13" kind="example" id="ex_5.13" topic="Continuity of a piecewise function split at 0" corrections_applied="1"}
#### उदाहरण 13
...
:::example{number="24" kind="example" id="ex_5.24" topic="Whether x=e^(log x) holds for all real x" simplified="True"}
#### उदाहरण 24
...
:::solution{label="हल"}
हल पहले तो ध्यान दीजिए कि log फलन का प्रांत सभी धन वास्तविक संख्याओं का समुच्चय होता है। इसलिए उपर्युक्त समीकरण धनेतर वास्तविक संख्याओं के लिए सत्य नहीं है। अब मान लीजिए कि $y=e^{\log x}$ है। यदि $y>0$ है। दोनों पक्षों का लघुगणक लेने पर, $\log y=\log \left(e^{\log x}\right)=\log x \cdot \log$ $e=\log x$ है। जिससे $y=x$ प्राप्त होता है। अतएव $x=e^{\log x}$ केवल $x$ के धन मानों के लिए सत्य है।
:::
...
:::example{number="25" kind="example" id="ex_5.25" topic="Differentiating exponential/logarithmic composite functions" corrections_applied="2"}
#### उदाहरण 25
...
:::solution
मान लीजिए कि $y=\sin (\log x)$ है। अब शृंखला नियम द्वारा
$$
...
:::example{number="39" kind="example" id="ex_5.39" topic="Differentiating inverse trig compositions" simplified="True"}
#### उदाहरण 39
...
:::solution
मान लीजिए कि $f(x)=\tan ^{-1}\left(\frac{\sin x}{1+\cos x}\right)$ है। ध्यान दीजिए कि यह फलन उन सभी वास्तविक संख्याओं के लिए परिभाषित है जिनके लिए $\cos x \neq-1$ है, अर्थात् $\pi$ के समस्त विषम गुणजों के अतिरिक्त अन्य सभी वास्तविक संख्याओं के लिए। हम इस फलन को निम्नलिखित प्रकार से पुनः व्यक्त कर सकते हैं:
...
धन राशि है, इसलिए हमें उन सभी $x$ को ज्ञात करना है जिनके लिए $\frac{2^{x+1}}{1+4^{x}} \leq 1$ है, अर्थात् वे सभी $x$ जिनके लिए $2^{x+1} \leq 1+4^{x}$ है। हम इसको $2 \leq \frac{1}{2^{x}}+2^{x}$ प्रकार भी लिख सकते हैं, जो सभी $x$ के लिए सत्य है। अतः फलन प्रत्येक वास्तविक संख्या के लिए परिभाषित है। अब $2^{x}=\tan \theta$ रखने पर यह फलन निम्नलिखित प्रकार से पुनः लिखा जा सकता है:
...
:::solution{label="हल"}
माना, $k$ कोई वास्तविक संख्या है। प्रश्नानुसार $k<0$ या $k=0$ या $0 \leq k \leq 1$ या $k=1$ या $k>1$
...
:::question{number="22" kind="exercise" id="q_5.1.22" topic="Continuity of cosine, cosecant, secant and cotangent" simplified="True"}
#### प्रश्न 22
...
:::question{number="31" kind="exercise" id="q_5.1.31" topic="Continuity of cos(x^2)" simplified="True"}
#### प्रश्न 31
...
:::question{number="32" kind="exercise" id="q_5.1.32" topic="Continuity of the absolute value of cosine" simplified="True"}
#### प्रश्न 32
...
:::question{number="33" kind="exercise" id="q_5.1.33" topic="Continuity check of sin|x|" simplified="True"}
#### प्रश्न 33
...
:::question{number="34" kind="exercise" id="q_5.1.34" topic="Points of discontinuity of |x|-|x+1|" simplified="True"}
#### प्रश्न 34
...
:::question{number="7" kind="exercise" id="q_5.2.7" topic="Chain rule differentiation with a square root" corrections_applied="1"}
#### प्रश्न 7
...
& =\frac{1}{\sqrt{\cot \left(x^{2}\right)}} \cdot\left[-\operatorname{cossec} x^{2}\right] \cdot 2 x
\end{aligned}
$$
:::
...
:::question{number="10" kind="exercise" id="q_5.5.10" topic="Logarithmic differentiation of a sum with a rational function" simplified="True"}
#### प्रश्न 10
...
:::question{number="17" kind="exercise" id="q_5.5.17" topic="Differentiating a product three ways and verifying equal results" corrections_applied="2"}
#### प्रश्न 17

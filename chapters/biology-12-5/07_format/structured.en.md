...
:::question{number="5.1" kind="exercise" id="q_5.1" topic="Nitrogenous bases vs nucleosides"}
#### Question 5.1
...
:::question{number="5.2" kind="exercise" id="q_5.2" topic="Chargaff's rule base percentage" simplified="True"}
#### Question 5.2
...
:::solution{label="Solution"}
:::concept{label="Chargaff's rule"}
According to Chargaff's rule, the DNA molecule should have an equal ratio of pyrimidine (cytosine and thymine) and purine (adenine and guanine). It means that the number of adenine molecules equals the number of thymine molecules, and the number of guanine molecules equals the number of cytosine molecules.
:::
...
:::question{number="5.3" kind="exercise" id="q_5.3" topic="Complementary DNA strand sequence" corrections_applied="1"}
#### Question 5.3
...
:::question{number="5.4" kind="exercise" id="q_5.4" topic="mRNA sequence from coding strand"}
#### Question 5.4
...
:::question{number="5.5" kind="exercise" id="q_5.5" topic="Semi-conservative DNA replication"}
#### Question 5.5
...
:::figure{src="images/fig_5_24.jpg" id="fig_5_24"}
:::
:::

:::

:::question{number="5.6" kind="exercise" id="q_5.6" topic="Types of nucleic acid polymerases"}
#### Question 5.6
...
:::concept{label="Types of nucleic acid polymerases"}
...
:::question{number="5.7" kind="exercise" id="q_5.7" topic="Hershey-Chase experiment"}
#### Question 5.7
...
:::figure{src="images/fig_5_25.jpg" id="fig_5_25"}
...
:::question{number="5.8" kind="exercise" id="q_5.8" topic="Repetitive/satellite DNA, mRNA/tRNA, template/coding strand"}
#### Question 5.8
...
:::question{number="5.9" kind="exercise" id="q_5.9" topic="Roles of ribosome in translation" simplified="True"}
#### Question 5.9
...
:::concept{label="Functions of ribosome"}
- Ribosome is the site where protein synthesis takes place from individual amino acids. It has two subunits. The smaller subunit binds to mRNA and forms a protein synthesizing complex, while the larger subunit acts as the amino acid binding site.
- Ribosome acts as a catalyst for forming the peptide bond. For example, 23s $r$-RNA in bacteria acts as a ribozyme.
:::
:::

:::

:::question{number="5.10" kind="exercise" id="q_5.10" topic="Lac operon shutdown mechanism"}
#### Question 5.10
...
:::figure{src="images/fig_5_26.jpg" id="fig_5_26"}
:::
:::

:::

:::question{number="5.11" kind="exercise" id="q_5.11" topic="Promoter, tRNA, exon functions"}
#### Question 5.11
...
:::question{number="5.12" kind="exercise" id="q_5.12" topic="Human Genome Project as a mega project"}
#### Question 5.12
...
:::question{number="5.13" kind="exercise" id="q_5.13" topic="DNA fingerprinting and its applications"}
#### Question 5.13
...
:::question{number="5.14" kind="exercise" id="q_5.14" topic="Transcription, polymorphism, translation, bioinformatics" simplified="True"}
#### Question 5.14
...
:::figure{src="images/fig_5_27.jpg" id="fig_5_27"}
...
This heritable mutation is observed at a high frequency in a population. It arises due to mutation either in somatic cell or in the germ cells. The germ cell mutation can be transmitted from parents to their offsprings. This results in accumulation of various mutations in a population, leading to variation and polymorphism in the population. This plays a very important role in the process of evolution and speciation.
:::
...
:::figure{src="images/fig_5_28.jpg" id="fig_5_28"}
...
:::solution
:::concept{label="Bioinformatics"}
Bioinformatics is the application of computational and statistical techniques to the field of molecular biology.
:::

It solves the practical problems arising from the management and analysis of biological data. The field of bioinformatics developed after the completion of human genome project (HGP). This is because an enormous amount of data was generated during the process of HGP. This data has to be managed and stored for easy access, and interpreted for future use by various scientists. Hence, bioinformatics involves the creation of biological databases that store the vast information of biology.

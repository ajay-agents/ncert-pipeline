...
:::example{number="1.1" kind="example" id="ex_1.1" topic="Mole fraction from mass percent" corrections_applied="1"}
#### Example 1.1
...
:::example{number="1.4" kind="example" id="ex_1.4" topic="Henry's law solubility of nitrogen in water"}
#### Example 1.4
...
:::example{number="1.5" kind="example" id="ex_1.5" topic="Vapour pressure of an ideal binary solution" corrections_applied="1"}
#### Example 1.5
...
:::example{number="1.6" kind="example" id="ex_1.6" topic="Molar mass from vapour pressure lowering"}
#### Example 1.6
...
:::example{number="1.7" kind="example" id="ex_1.7" topic="Boiling point elevation of a glucose solution" corrections_applied="1"}
#### Example 1.7
...
:::example{number="1.8" kind="example" id="ex_1.8" topic="Molar mass from boiling point elevation"}
#### Example 1.8
...
:::example{number="1.9" kind="example" id="ex_1.9" topic="Freezing point depression of ethylene glycol solution"}
#### Example 1.9
...
:::example{number="1.11" kind="example" id="ex_1.11" topic="Molar mass of a protein from osmotic pressure"}
#### Example 1.11
...
:::example{number="1.12" kind="example" id="ex_1.12" topic="Association of benzoic acid in benzene"}
#### Example 1.12
...
:::example{number="1.13" kind="example" id="ex_1.13" topic="Van't Hoff factor and dissociation constant of acetic acid"}
#### Example 1.13
...
:::question{number="1.13" kind="exercise" id="q_1.13" topic="Partial pressure of ethane from Henry's law"}
#### Question 1.13
...
:::question{number="1.14" kind="exercise" id="q_1.14" topic="Positive/negative deviation from Raoult's law and mixing enthalpy"}
#### Question 1.14
...
:::question{number="1.15" kind="exercise" id="q_1.15" topic="Molar mass of solute from vapour pressure"}
#### Question 1.15
...
:::question{number="1.17" kind="exercise" id="q_1.17" topic="Vapour pressure of a 1 molal non-volatile solute solution"}
#### Question 1.17
...
:::question{number="1.18" kind="exercise" id="q_1.18" topic="Mass of solute to reduce vapour pressure by 20%"}
#### Question 1.18
...
:::question{number="1.20" kind="exercise" id="q_1.20" topic="Freezing point of glucose solution from cane sugar data"}
#### Question 1.20
...
:::question{number="1.21" kind="exercise" id="q_1.21" topic="Atomic masses of A and B from freezing point depression"}
#### Question 1.21
...
:::question{number="1.22" kind="exercise" id="q_1.22" topic="Concentration of glucose solution from osmotic pressure"}
#### Question 1.22
...
:::question{number="1.24" kind="exercise" id="q_1.24" topic="Increasing solubility order in n-octane"}
#### Question 1.24
...
:::question{number="1.27" kind="exercise" id="q_1.27" topic="Maximum molarity of CuS from solubility product"}
#### Question 1.27
...
:::question{number="1.29" kind="exercise" id="q_1.29" topic="Mass of nalorphene solution for a given dose"}
#### Question 1.29
...
:::question{number="1.30" kind="exercise" id="q_1.30" topic="Amount of benzoic acid for a molar solution in methanol"}
#### Question 1.30
...
:::question{number="1.31" kind="exercise" id="q_1.31" topic="Trend in freezing point depression across acetic/trichloroacetic/trifluoroacetic acid"}
#### Question 1.31
...
:::question{number="1.39" kind="exercise" id="q_1.39" topic="Composition of dissolved O2 and N2 in water from air"}
#### Question 1.39
...
:::question{number="1.7" kind="additional_exercise" id="it_1.7" topic="Quantity of CO2 dissolved in soda water"}
...
:::question{number="1.8" kind="additional_exercise" id="it_1.8" topic="Composition of liquid and vapour phase from vapour pressures"}
...
:::question{number="1.9" kind="additional_exercise" id="it_1.9" topic="Vapour pressure lowering from urea solution"}
...
:::question{number="1.10" kind="additional_exercise" id="it_1.10" topic="Sucrose needed to raise boiling point to 100 C"}
...
:::question{number="1.11" kind="additional_exercise" id="it_1.11" topic="Mass of ascorbic acid for a given freezing point depression"}

...
:::solution{label="Solution"}
Linkage is the coexistence of two or more genes on the same chromosome. Genes that lie close together on the same chromosome are inherited together, and are called linked genes. For example, a cross between a yellow-bodied, white-eyed Drosophila and a wild-type Drosophila produces wild-type and yellow-white progenies, because the yellow-body and white-eye genes are linked and so inherited together.
:::

...
:::question{number="4.1" kind="exercise" id="q_4.1" topic="Advantages of pea plant for Mendel's experiments"}
#### Question 4.1
...
:::concept{label="Reasons pea plants were chosen"}
...
:::question{number="4.2" kind="exercise" id="q_4.2" topic="Key genetics term pairs"}
#### Question 4.2
...
:::question{number="4.3" kind="exercise" id="q_4.3" topic="Gametes from a tetra-heterozygous organism" simplified="True"}
#### Question 4.3
...
:::solution{label="Solution"}
:::concept{label="Locus"}
Locus is a fixed position on a chromosome, occupied by one or more genes.
:::

Heterozygous organisms contain different alleles for an allelic pair. So, a diploid organism that is heterozygous at four loci will have four different contrasting characters at four different loci.
...
:::figure{src="images/fig_4_61.jpg" id="fig_4_61"}
:::
...
:::solution{label="Solution"}
:::concept{label="Law of Dominance"}
...
:::figure{src="images/fig_4_62.jpg" id="fig_4_62"}
:::
:::
...
:::figure{src="images/fig_4_63.jpg" id="fig_4_63"}
:::
:::
...
:::figure{src="images/fig_4_64.jpg" id="fig_4_64"}
:::
:::
...
:::solution
one dwarf and green plant
:::

:::

:::figure{src="images/fig_4_65.jpg" id="fig_4_65"}
:::

:::

:::question{number="4.8" kind="exercise" id="q_4.8" topic="Linked genes in a dihybrid cross" simplified="True"}
#### Question 4.8
...
:::solution{label="Solution"}
:::concept{label="Linkage"}
Linkage is the coexistence of two or more genes on the same chromosome. Genes that lie close together on the same chromosome are inherited together, and are called linked genes.
:::

For example, a cross between a yellow-bodied, white-eyed Drosophila and a wild-type Drosophila produces wild-type and yellow-white progenies, because the yellow-body and white-eye genes are linked and so inherited together.

:::figure{src="images/fig_4_66.jpg" id="fig_4_66"}
:::
:::
...
:::question{number="4.10" kind="exercise" id="q_4.10" topic="Pedigree analysis" simplified="True"}
#### Question 4.10
...
:::solution{label="Solution"}
:::concept{label="Pedigree analysis"}
Pedigree analysis is a record of how a trait appears across several generations of a family. It is based on the fact that certain characteristic features are heritable in a family, for example, eye colour, skin colour, hair form and colour, and other facial characteristics.
:::

Genetic disorders, such as Mendelian disorders, are also inherited in a family from one generation to the next. So, pedigree analysis can be used to study specific traits or disorders across generations and trace their pattern of inheritance. In this analysis, the inheritance of a trait is represented as a tree, called a family tree. Genetic counsellors use a pedigree chart to analyse various traits and diseases in a family and predict their inheritance patterns. It is useful in preventing hemophilia, sickle cell anemia, and other genetic disorders in future generations.
:::

:::

:::question{number="4.11" kind="exercise" id="q_4.11" topic="Sex determination in humans" simplified="True"}
#### Question 4.11
...
:::figure{src="images/fig_4_67.jpg" id="fig_4_67"}
:::
:::

:::

:::question{number="4.12" kind="exercise" id="q_4.12" topic="ABO blood group inheritance" simplified="True"}
#### Question 4.12
...
:::solution{label="Solution"}
:::concept{label="ABO blood group alleles"}
The blood group characteristic in humans is controlled by three set of alleles, namely, $\mathrm{I}^{\mathrm{A}}, \mathrm{I}^{\mathrm{B}}$, and i. The alleles, $\mathrm{I}^{\mathrm{A}}$ and $\mathrm{I}^{\mathrm{B}}$, are equally dominant whereas allele, i , is recessive to the other alleles. The individuals with genotype, $\mathrm{I}^{\mathrm{A}}$ $\mathrm{I}^{\mathrm{A}}$ and $\mathrm{I}^{\mathrm{A}} \mathrm{i}$, have blood group A whereas the individuals with genotype, $\mathrm{I}^{\mathrm{B}} \mathrm{I}^{\mathrm{B}}$ and $\mathrm{I}^{\mathrm{B}} \mathrm{i}$, have blood group B. The persons with genotype $\mathrm{I}^{\mathrm{A}} \mathrm{I}^{\mathrm{B}}$ have blood group AB while those with blood group O have genotype ii.
:::
...
:::figure{src="images/fig_4_68.jpg" id="fig_4_68"}
:::
...
:::figure{src="images/fig_4_69.jpg" id="fig_4_69"}
:::
:::

:::

:::question{number="4.13" kind="exercise" id="q_4.13" topic="Co-dominance and incomplete dominance"}
#### Question 4.13
...
:::solution
:::concept{label="Incomplete dominance"}
...
:::figure{src="images/fig_4_70.jpg" id="fig_4_70"}
:::
:::
:::
...
:::solution{label="Solution"}
:::concept{label="Point mutation"}
Point mutation is a change in a single base pair of DNA by substitution of one nitrogenous base for another (deletion or insertion of a base instead causes a frame-shift mutation).
:::

An example of point mutation is sickle cell anaemia. It involves a single base substitution (from GAG to GUG) at the sixth codon of the beta-globin gene, located on chromosome 11, causing glutamic acid to be replaced by valine at the sixth position of the beta-globin chain of haemoglobin.
:::

:::

:::question{number="4.15" kind="exercise" id="q_4.15" topic="Chromosomal theory of inheritance"}
#### Question 4.15
...
:::question{number="4.16" kind="exercise" id="q_4.16" topic="Autosomal genetic disorders" simplified="True"}
#### Question 4.16
...
:::concept{label="Sickle cell Anaemia (a Mendelian, single-gene disorder)"}
...
:::concept{label="Down's syndrome (a chromosomal disorder)"}

...
:::question{number="2.1" kind="exercise" id="q_2.1" topic="Fill in the blanks - reproduction basics"}
#### प्रश्न 2.1
...
:::part{label="(क)"}
:::prompt
मानव $\_\_\_\_$ उत्पत्ति वाला है। (अलैंगिक/लेंगिक)
:::
...
:::question{number="2.12" kind="exercise" id="q_2.12" topic="Oogenesis explained"}
#### प्रश्न 2.12
...
:::solution
झालर (फिम्बी-Fimbriae)-अण्डवाहिनी (oviduct) का प्रारम्भिक फनल सदृश चौड़ा भाग जो अण्डाशय के सम्पर्क में होता है, मुखिका (ostium) कहलाता है। यह झालरदार तथा रोमाभि (fimbriated and ciliated) होता है। इसकी अंगुली सदृश रचनाओं को फिम्ब्री कहते हैं। ये अण्डाणुओं को ग्रहण करने में सहायक होती हैं।
:::
...
:::part{label="(च)"}
:::prompt
सगर्भता (प्रेगनेंसी) के दौरान आर्तव चक्र (मेन्सट्रुअल साइकिल) बंद होता है। (सही/गलत)
:::
...
:::question{number="2.19" kind="exercise" id="q_2.19" topic="Sex determination is not the mother's fault"}
#### प्रश्न 2.19

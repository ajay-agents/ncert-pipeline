...
:::step{n="3" label="Inverse function"}
...
:::step{n="1" label="g is not injective"}
...
:::step{n="2" label="gof is injective"}
...
:::solution{label="Solution"}
:::step{n="1" label="Identity element"}
$$
\begin{aligned}
...
:::step{n="2" label="Invertible element"}
...
:::step{n="1" label="Commutativity of *"}
$\therefore a^{*} b=b^{*} a$
∴ The operation * is commutative.
:::

:::step{n="2" label="Associativity of *"}
$$
\begin{aligned}
...
:::step{n="3" label="Commutativity of o"}
...
:::step{n="4" label="Associativity of o"}
...
:::step{n="5" label="Distributivity: * over o"}
...
:::step{n="6" label="Distributivity: o over *"}
Now,
...
:::step{n="2" label="Inverse element"}

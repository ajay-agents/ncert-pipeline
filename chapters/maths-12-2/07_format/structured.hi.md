...
अब, $\cos ^{-1}\left(\frac{1}{2}\right)+2 \sin ^{-1}\left(\frac{1}{2}\right)=\frac{\pi}{3}+2 \times \frac{\pi}{6}=\frac{\pi}{3}+\frac{\pi}{3}=\frac{2 \pi}{3}$.
:::
:::
...
हम जानते हैं कि $\tan ^{-1}$ की मुख्य शाखा का परिसर $\left(-\frac{\pi}{2}, \frac{\pi}{2}\right)$ होता है। $\therefore \tan ^{-1} \sqrt{3}=\frac{\pi}{3}$
:::

:::step{n="2"}
माना, $\sec ^{-1}(-2)=\mathrm{y}$, इसलिए,

$$
\sec y=-2=-\sec \frac{\pi}{3}=\sec \left(\pi-\frac{\pi}{3}\right)=\sec \left(\frac{2 \pi}{3}\right)
$$

हम जानते हैं कि $\sec ^{-1}$ की मुख्य शाखा का परिसर $[0, \pi]-\left\{\frac{\pi}{2}\right\}$ होता है। $\therefore \sec ^{-1}(-2)=\frac{2 \pi}{3}$
:::
...
:::solution{label="हल"}
:::concept{label="जानकारी"}
माना, $\sin ^{-1} x=\theta$, तब $x=\sin \theta$ है।
:::
...
:::solution{label="हल"}
:::concept{label="जानकारी"}
माना, $\cos ^{-1} x=\theta$, तब $x=\cos \theta$ है।
:::

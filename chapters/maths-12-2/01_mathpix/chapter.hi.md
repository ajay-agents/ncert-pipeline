...
tangent फलन, अर्थात्, $\tan : \mathbf{R}-\left\{x: x=(2 n+1) \frac{\pi}{2}, n \in \mathbf{Z}\right\} \rightarrow \mathbf{R}$ cotangent फलन, अर्थात्, $\cot : \mathbf{R}-\{x: x=n \pi, n \in \mathbf{Z}\} \rightarrow \mathbf{R}$ secant फलन, अर्थात्, sec : $\mathbf{R}-\left\{x: x=(2 n+1) \frac{\pi}{2}, n \in \mathbf{Z}\right\} \rightarrow \mathbf{R}-(-1,1)$ cosecant फलन, अर्थात्, cosec : $\mathbf{R}-\{x: x=n \pi, n \in \mathbf{Z}\} \rightarrow \mathbf{R}-(-1,1)$

हम अध्याय $1$ में यह भी सीख चुके हैं कि यदि $f: \mathrm{X} \rightarrow \mathbb{X}$ इस प्रकार है कि $f(x)=y$ एक एकैकी तथा आच्छादक फलन हो तो हम एक अद्वितीय फलन $g: \mathrm{Y} \rightarrow \mathrm{X}$ इस प्रकार परिभाषित कर सकते हैं कि $g(y)=x$, जहाँ $x \in \mathrm{X}$ तथा $y=f(x), y \in \mathrm{Y}$ है। यहाँ $g$ का प्रांत $=f$ का परिसर और $g$ का परिसर $=f$ का प्रांत। फलन $g$ को फलन $f$ का प्रतिलोम कहते हैं और इसे $f^{-1}$ द्वारा निरूपित करते हैं। साथ ही $g$ भी एकैकी तथा आच्छादक होता है और $g$ का प्रतिलोम फलन $f$ होता हैं अत: $g^{-1}=\left(f^{-1}\right)^{-1}=f$ इसके साथ ही
...
प्रतिलोम फलन की परिभाषा द्वारा, यह निष्कर्ष निकलता है कि $\sin \left(\sin ^{-1} x\right)=x$, यदि $-1 \leq x \leq$ तथा $\sin ^{-1}(\sin x)=x$ यदि $-\frac{\pi}{2} \leq x \leq \frac{\pi}{2}$ है। दूसरे शब्दों में, यदि $y=\sin ^{-1} x$ हो तो $\sin y=x$ होता है।
...
![](images/fig_maths-12-2_1.jpg)
आकृति $2.1$ (i)

![](images/fig_maths-12-2_2.jpg)
...
sine फलन के समान cosine फलन भी एक ऐसा फलन है जिसका प्रांत वास्तविक संख्याओं का समुच्चय है और जिसका परिसर समुच्चय $[-1,1]$ है। यदि हम cosine फलन के प्रांत को अंतराल $[0, \pi]$ में सीमित कर दें तो यह परिसर $[-1,1]$ वाला एक एकैकी तथा आच्छादक फलन हो जाता है। वस्तुत:, cosine फलन, अंतरालों $[-\pi, 0],[0, \pi],[\pi, 2 \pi]$ इत्यादि में से किसी में भी सीमित होने से, परिसर $[-1,1]$ वाला एक एकैकी आच्छादी (Bijective) फलन हो जाता है। अतः हम इन में से प्रत्येक अंतराल में cosine फलन के प्रतिलोम को परिभाषित कर सकते हैं। हम cosine फलन के प्रतिलोम फलन को $\cos ^{-1}$ (arc cosine function) द्वारा निरूपित करते कहलाती है और हम लिखते हैं कि में दिखलाया गया है। हैं। अतः $\cos ^{-1}$ एक फलन है जिसका प्रांत $[-1,1]$ है और परिसर $[-\pi, 0]$, $[0, \pi],[\pi, 2 \pi]$ इत्यादि में से कोई भी अंतराल हो सकता है। इस प्रकार के प्रत्येक अंतराल के संगत हमें फलन $\cos ^{-1}$ की एक शाखा प्राप्त होती है। वह शाखा, जिसका परिसर $[0, \pi]$ है, मुख्य शाखा (मुख्य मान शाखा)

$$
\cos ^{-1}:[-1,1] \rightarrow[0, \pi]
$$

$y=\cos ^{-1} x$ द्वारा प्रदत्त फलन का आलेख उसी प्रकार खींचा जा सकता है जैसा कि $y=\sin ^{-1} x$ के आलेख के बारे में वर्णन किया जा चुका है। $y=\cos x$ तथा $y=\cos ^{-1} x$ के आलेखों को आकृतियों $2.2$ (i) तथा (ii)

आकृति $2.2$ (i)
![](images/fig_maths-12-2_4.jpg)
...
![](images/fig_maths-12-2_5.jpg)
आकृति $2.3$ (i)

![](images/fig_maths-12-2_6.jpg)
आकृति $2.3$ (ii)
...
![](images/fig_maths-12-2_7.jpg)
आकृति $2.4$ (i)

![](images/fig_maths-12-2_8.jpg)
आकृति $2.4$ (ii)
...
![](images/fig_maths-12-2_9.jpg)
आकृति $2.5$ (i)

![](images/fig_maths-12-2_10.jpg)
आकृति $2.5$ (ii)
...
![](images/fig_maths-12-2_11.jpg)
आकृति $2.6$ (i)

![](images/fig_maths-12-2_12.jpg)
आकृति $2.6$ (ii)
...
| :--- | :--- | :--- | :--- | :--- |
| $\cos ^{-1}$ | : | [-1, 1] | → | $[0, \pi]$ |
| $\operatorname{cosec}^{-1}$ | : | $\mathbf{R}-(-1,1)$ | → | $\left[-\frac{\pi}{2}, \frac{\pi}{2}\right]-\{0\}$ |
| $\mathrm{sec}^{-1}$ |  | R - (-1, 1) | → | $[0, \pi]-\left\{\frac{\pi}{2}\right\}$ |
...
स्मरण कीजिए कि, यदि $y=\sin ^{-1} x$ हो तो $x=\sin y$ तथा यदि $x=\sin y$ हो तो $y=\sin ^{-1} x$ होता है। यह इस बात के समतुल्य (Equivalent) है कि
...
(ii) मान लीजिए कि $x=\cos \theta$ तो उपर्युक्त विधि के प्रयोग द्वारा हमें $\sin ^{-1}\left(2 x \sqrt{1-x^{2}}\right)=2 \cos ^{-1} x$ प्राप्त होता है।
...
उदाहरण $6 \sin ^{-1}\left(\sin \frac{3 \pi}{5}\right)$ का मान ज्ञात कीजिए।
हल हमें ज्ञात है कि $\sin ^{-1}(\sin x)=x$ होता है। इसलिए $\sin ^{-1}\left(\sin \frac{3 \pi}{5}\right)=\frac{3 \pi}{5}$
...
10. $\tan ^{1}\left(\frac{\sqrt{1+x}-\sqrt{1-x}}{\sqrt{1+x}+\sqrt{1-x}}\right)=\frac{\pi}{4}-\frac{1}{2} \cos ^{1} x,-\frac{1}{\sqrt{2}} \leq x \leq 1$ [संकेत: $x=\cos 2 \theta$ रखिए] निम्नलिखित समीकरणों को सरल कीजिए:
11. $2 \tan ^{-1}(\cos x)=\tan ^{-1}(2 \operatorname{cosec} x)$
12. $\tan ^{-1} \frac{1-x}{1+x}=\frac{1}{2} \tan ^{-1} x,(x>0)$
13. $\sin \left(\tan ^{-1} x\right),|x|<1$ बराबर होता है:
(A) $\frac{x}{\sqrt{1-x^{2}}}$
(B) $\frac{1}{\sqrt{1-x^{2}}}$
(C) $\frac{1}{\sqrt{1+x^{2}}}$
(D) $\frac{x}{\sqrt{1+x^{2}}}$
...
| $y=\cos ^{-1} x$ | [-1, 1] | $[0, \pi]$ |
| $y=\operatorname{cosec}^{-1} x$ | R - (-1,1) | $\left[\frac{-\pi}{2}, \frac{\pi}{2}\right]-\{0\}$ |
...
भास्कर प्रथम ( $600$ ई.) ने $90^{\circ}$ से अधिक, कोणों के sine के मान के लए सूत्र दिया था। सोलहवीं शताब्दी का मलयालम भाषा में $\sin (\mathrm{A}+\mathrm{B})$ के प्रसार की एक उपपत्ति है। $18^{\circ}$, $36^{\circ}, 54^{\circ}, 72^{\circ}$, आदि के sine तथा cosine के विशुद्ध मान भास्कर द्वितीय द्वारा दिए गए हैं। $\sin ^{-1} x, \cos ^{-1} x$, आदि को चाप $\sin x$, चाप $\cos x$, आदि के स्थान पर प्रयोग करने का सुझाव ज्योतिषविद Sir John F.W. Hersehel ( $1813$ ई.) द्वारा दिए गए थे। ऊँचाई और दूरी संबंधित प्रश्नों के साथ Thales ( $600$ ई. पूर्व) का नाम अपरिहार्य रूप से जुड़ा हुआ है। उन्हें मिश्र के महान पिरामिड की ऊँचाई के मापन का श्रेय प्राप्त है। इसके लिए उन्होंने एक ज्ञात ऊँचाई के सहायक दंड तथा पिरामिड की परछाइयों को नापकर उनके अनुपातों की तुलना का प्रयोग किया था। ये अनुपात हैं

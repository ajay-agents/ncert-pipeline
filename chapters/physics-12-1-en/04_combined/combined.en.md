...
:::question{number="1.11" kind="exercise" id="q_1.11" topic="Electrons and mass transferred by friction"}
#### Question 1.11
...
:::prompt
Consider a uniform electric field $\mathbf{E}=3 \times 10^{3} \hat{\mathbf{1}} \mathrm{~N} / \mathrm{C}$.
:::
...
:::question{number="1.20" kind="exercise" id="q_1.20" topic="Net charge on a conducting sphere from field"}
#### Question 1.20

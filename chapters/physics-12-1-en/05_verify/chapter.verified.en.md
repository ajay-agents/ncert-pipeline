...
$$
However, it may be mentioned here that the signs of the two forces are different. For two protons, the gravitational force is attractive in nature and the Coulomb force is repulsive. The actual values of these forces between two protons inside a nucleus (distance between two protons is $\sim 10^{-15} \mathrm{~m}$ inside a nucleus) are $F_{\mathrm{e}} \sim 230 \mathrm{~N}$, whereas, $F_{\mathrm{G}} \sim 1.9 \times 10^{-34} \mathrm{~N}$.
...
:::question{number="1.14" kind="exercise" id="q_1.14" topic="Flux through a square in a uniform field" corrections_applied="1"}
#### Question 1.14

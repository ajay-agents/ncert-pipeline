# -*- coding: utf-8 -*-
"""Stage 9 render script for physics-12-11 (Dual Nature of Radiation and
Matter / विकिरण तथा द्रव्य की द्वैत प्रकृति): reads 08_tag/structured.hi.json,
hand-templates it onto the house style (solutions-chapter-1.html's
exemplar), concretely modeled on chapters/physics-12-10/09_design/
render_page.py (the most recently proven and complete of this pipeline's
stage-9 scripts), and writes 09_design/final.hi.html + final.hi.css +
images/.

This chapter has no :::note or :::table content (all 14 items are either a
purely qualitative de Broglie/photon-relation argument or a numeric
given/formula/step derivation), so the note/table branches below are
inherited unused, kept only so this script stays a faithful copy of the
proven reference rather than a stripped-down one that might silently diverge
in behavior it does share.
"""
...
CH = os.path.join(ROOT, "chapters", "physics-12-11")

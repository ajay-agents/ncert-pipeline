...
:::example{number="5.1" kind="example" id="ex_5.1" topic="Cutting and testing a bar magnet"}
#### Example 5.1
...
:::solution
No force if the field is uniform. The iron nail experiences a nonuniform field due to the bar magnet. There is induced magnetic moment in the nail, therefore, it experiences both force and torque. The net force is attractive because the induced south pole (say) in the nail is closer to the north pole of magnet than induced north pole.
:::
...
:::solution
Bring different ends of the two bars close together. If you get a repulsive force in some orientation, both bars are magnetised. If the force is always attractive, one of them is not magnetised.

In a bar magnet, the field is strongest at the two ends (poles) and weakest at the centre. This lets us find which bar, A or B, is the magnet: pick up one bar (say A) and bring one of its ends near an end of the other bar (B), then near the middle of B. If A feels no force at the middle of B, then B is the magnet. If the force does not change from the end to the middle of B, then A is the magnet.
:::
...
:::example{number="5.2" kind="example" id="ex_5.2" topic="Equilibrium of a needle in another needle's field"}
#### Example 5.2
...
$$
\begin{array}{ll}
\mathbf{B}_{\mathrm{P}}=-\frac{\mu_{0}}{4 \pi} \frac{\mathbf{m}_{\mathrm{P}}}{r^{3}} & \text { (on the normal bisector) } \\
\mathbf{B}_{\mathrm{P}}=\frac{\mu_{0} 2}{4 \pi} \frac{\mathbf{m}_{\mathrm{P}}}{r^{3}} & \text { (on the axis) }
\end{array}
$$
where $\mathbf{m}_{\mathrm{P}}$ is the magnetic moment of the dipole P.
Equilibrium is stable when $\mathbf{m}_{\mathrm{Q}}$ is parallel to $\mathbf{B}_{\mathrm{P}}$, and unstable when it is anti-parallel to $\mathbf{B}_{\mathrm{P}}$.
$\mathrm{PQ}_{1}$ and $\mathrm{PO}_{2}$
:::
...
:::solution
(i) $\mathrm{PG}_{3}, \mathrm{PO}_{6}$ (stable); (ii) $\mathrm{PQ}_{5}, \mathrm{PQ}_{4}$ (unstable)
:::
...
:::example{number="5.3" kind="example" id="ex_5.3" topic="Spotting wrong field-line diagrams"}
#### Example 5.3
...
:::answer
**Answer:** (a),(b),(d),(f),(g) wrong; (c),(e) right
:::

:::

:::example{number="5.4" kind="example" id="ex_5.4" topic="Conceptual questions on field lines and monopoles"}
#### Example 5.4
...
:::solution
No. The magnetic force is always normal to B (remember magnetic force $=q \mathbf{v} \quad \mathbf{B}$ ). It is misleading to call magnetic field lines as lines of force.
:::
...
:::solution
Gauss's law of magnetism states that the flux of B through any closed surface is always zero $\int_{\mathrm{S}} \mathbf{B} . \Delta \mathbf{s}=0$.
If monopoles existed, the right hand side would be equal to the monopole (magnetic charge) $q_{m}$ enclosed by S. [Analogous to Gauss's law of electrostatics, $\int_{\mathrm{S}} \mathbf{B} . \Delta \mathbf{s}=\mu_{0} q_{m}$ where $q_{m}$ is the (monopole) magnetic charge enclosed by $S$.]
:::
...
:::solution
No. There is no force or torque on an element due to the field produced by that element itself. But there is a force (or torque) on an element of the same wire. (For the special case of a straight wire, this force is zero.)
:::
...
:::solution
Yes. The average of the charge in the system may be zero. Yet, the mean of the magnetic moments due to various current loops may not be zero. We will come across such examples in connection with paramagnetic material where atoms have net dipole moment through their net charge is zero.
:::
...
:::example{number="5.5" kind="example" id="ex_5.5" topic="Field, magnetisation and current in a solenoid with a core"}
#### Example 5.5
...
:::solution{label="Solution"}
(a) The field $H$ is dependent of the material of the core, and is $H=n I=1000 \times 2.0=2 \times 10^{3} \mathrm{~A} / \mathrm{m}$.
...
\end{aligned}
$$
(d) The magnetising current $I_{M}$ is the additional current that needs to be passed through the windings of the solenoid in the absence of the core which would give a $B$ value as in the presence of the core. Thus $B=\mu_{r} n\left(I+I_{M}\right)$. Using $I=2 \mathrm{~A}, B=1 \mathrm{~T}$, we get $I_{M}=794 \mathrm{~A}$.
:::

:::answer
**Answer:** $H=2 \times 10^{3}\ \mathrm{A/m}$; $B=1.0\ \mathrm{T}$; $M \cong 8 \times 10^{5}\ \mathrm{A/m}$; $I_M=794\ \mathrm{A}$
:::
...
:::question{number="5.1" kind="exercise" id="q_5.1" topic="Magnetic moment of a bar magnet from torque"}
#### Question 5.1
...
:::answer
**Answer:** $0.36\ \mathrm{J\,T^{-1}}$
:::

:::

:::question{number="5.2" kind="exercise" id="q_5.2" topic="Stable and unstable equilibrium of a bar magnet"}
#### Question 5.2

:::prompt
A short bar magnet of magnetic moment $\mathrm{m}=0.32 \mathrm{JT}^{-1}$ is placed in a uniform magnetic field of 0.15 T. If the bar is free to rotate in the plane of the field, which orientation would correspond to its (a) stable, and (b) unstable equilibrium? What is the potential energy of the magnet in each case?
:::
...
:::answer
**Answer:** stable: $\theta=0°$, $U=-4.8\times10^{-2}$ J; unstable: $\theta=180°$, $U=4.8\times10^{-2}$ J
:::

:::

:::question{number="5.3" kind="exercise" id="q_5.3" topic="Magnetic moment of a current-carrying solenoid"}
#### Question 5.3
...
:::answer
**Answer:** $0.6\ \mathrm{J\,T^{-1}}$
:::

:::

:::question{number="5.4" kind="exercise" id="q_5.4" topic="Torque on a solenoid turning about a vertical axis"}
#### Question 5.4
...
:::answer
**Answer:** $7.5 \times 10^{-2}\ \mathrm{J}$
:::

:::

:::question{number="5.5" kind="exercise" id="q_5.5" topic="Work and torque turning a bar magnet in a field"}
#### Question 5.5
...
:::answer
**Answer:** (i) $W=0.33$ J, (ii) $W=0.66$ J; torque (i) $=0.33$ J, torque (ii) $=0$ J
:::

:::

:::question{number="5.6" kind="exercise" id="q_5.6" topic="Magnetic moment, force and torque on a suspended solenoid"}
#### Question 5.6
...
(b) What is the force and torque on the solenoid if a uniform horizontal magnetic field of $7.5 \times 10^{-2} \mathrm{~T}$ is set up at an angle of 30° with the axis of the solenoid?
:::
...
:::part{label="b"}
:::prompt
What is the force and torque on the solenoid if a uniform horizontal magnetic field of $7.5 \times 10^{-2} \mathrm{~T}$ is set up at an angle of 30° with the axis of the solenoid?
:::
...
:::answer
**Answer:** $M=1.28\ \mathrm{A\,m^2}$; force zero; torque $4.8 \times 10^{-2}\ \mathrm{N\,m}$
:::

:::

:::question{number="5.7" kind="exercise" id="q_5.7" topic="Axial and equatorial field of a bar magnet"}
#### Question 5.7
...
:::answer
**Answer:** axis: $0.96$ G, S-N direction; equatorial: $0.48$ G, N-S direction
:::
...
:::question{number="1" kind="additional_exercise" id="sol_5.1" topic="Three quantities specifying earth's field"}
...
:::question{number="2" kind="additional_exercise" id="sol_5.2" topic="Conceptual questions on earth's magnetism"}
...
:::question{number="9" kind="additional_exercise" id="sol_5.9" topic="Moment of inertia of an oscillating coil"}
...
:::answer
**Answer:** $1.19 \times 10^{-4}\ \mathrm{kg\,m^2}$
:::

:::

:::question{number="10" kind="additional_exercise" id="sol_5.10" topic="Earth's field from dip angle and horizontal component"}
...
:::question{number="11" kind="additional_exercise" id="sol_5.11" topic="Earth's field from declination and dip"}
...
:::answer
**Answer:** $0.32$ G, in the vertical plane 12° West of geographic meridian, 60° above horizontal
:::

:::

:::question{number="13" kind="additional_exercise" id="sol_5.13" topic="Total field at a magnet's null-point distance"}
...
:::answer
**Answer:** $0.54$ G, in the direction of earth's magnetic field
:::

:::

:::question{number="14" kind="additional_exercise" id="sol_5.14" topic="New null points after reversing a magnet"}
...
:::answer
**Answer:** $11.1$ cm on the normal bisector
:::

:::

:::question{number="15" kind="additional_exercise" id="sol_5.15" topic="Distance for a 45-degree resultant field"}
#### Additional Question 15

:::prompt
A short bar magnet of magnetic moment $5.25 \times 10^{-2} \mathrm{~J} \mathrm{~T}^{-1}$ is placed with its axis perpendicular to the earth's field direction. At what distance from the centre of the magnet, the resultant field is inclined at 45° with earth's field on its normal bisector and (b) its axis. Magnitude of the earth's field at the place is given to be 0.42 G. Ignore the length of the magnet in comparison to the distances involved.
:::
...
:::answer
**Answer:** normal bisector: $R=5$ cm; axis: $R'=6.3$ cm
:::

:::

:::question{number="16" kind="additional_exercise" id="sol_5.16" topic="Conceptual questions on dia-, para- and ferromagnetism"}
...
:::solution{label="Solution"}
(a) Random thermal motion disrupts the alignment of dipoles at high temperature. Cooling reduces this disruption, so a paramagnetic sample shows greater magnetisation when cooled.
(b) In a diamagnetic substance, the induced dipole moment always opposes the magnetising field. So the atoms' internal motion, which depends on temperature, does not affect diamagnetism.
(c) Bismuth is diamagnetic. So a toroid with a bismuth core has a magnetic field slightly greater than a toroid with an empty core.
(d) The permeability of a ferromagnetic material depends on the applied field: it is greater for a lower field, and vice versa.
(e) A ferromagnetic material's permeability is always greater than one. That is why magnetic field lines stay nearly normal to its surface at every point.
(f) A paramagnetic sample's maximum possible magnetisation can be of the same order as a ferromagnet's, but this needs a very high magnetising field to reach saturation.
:::

:::

:::question{number="17" kind="additional_exercise" id="sol_5.17" topic="Hysteresis, memory storage and magnetic shielding"}
...
:::solution{label="Solution"}
The hysteresis curve ($B-H$ curve) of a ferromagnetic material is shown in the figure below.
The curve shows that magnetisation persists even after the external field is removed - this is the irreversibility of a ferromagnet.
(b) The heat dissipated is directly proportional to the area of the hysteresis loop. A carbon steel piece has a greater loop area, so it dissipates more heat.
(c) The magnetisation value is a record of the hysteresis cycle it went through - these are bits of information tied to that cycle. So a hysteresis loop can be used to store information.
(d) Ceramic is used to coat magnetic tapes in cassette players and to build memory stores in modern computers.
(e) A region of space can be shielded from magnetic fields by surrounding it with soft iron rings, which draw the magnetic field lines out of that region.
:::

:::

:::question{number="18" kind="additional_exercise" id="sol_5.18" topic="Neutral points near a current-carrying cable"}
...
:::answer
**Answer:** $1.51$ cm, parallel to and above the cable
:::

:::

:::question{number="19" kind="additional_exercise" id="sol_5.19" topic="Resultant field near a telephone cable"}
...
:::answer
**Answer:** 4 cm below: $0.25$ G; 4 cm above: $0.56$ G
:::

:::

:::question{number="20" kind="additional_exercise" id="sol_5.20" topic="Horizontal field from a compass-deflecting coil"}
...
:::answer
**Answer:** $B_H=0.388$ G; needle points East to West after reversal
:::

:::

:::question{number="21" kind="additional_exercise" id="sol_5.21" topic="Second field magnitude for a dipole's equilibrium"}
...
:::answer
**Answer:** $4.39 \times 10^{-3}$ T
:::

:::

:::question{number="22" kind="additional_exercise" id="sol_5.22" topic="Deflection of an electron beam in earth's field"}
...
:::question{number="23" kind="additional_exercise" id="sol_5.23" topic="Dipole moment via Curie's law"}
...
:::answer
**Answer:** $10.336\ \mathrm{J\,T^{-1}}$
:::

:::

:::question{number="24" kind="additional_exercise" id="sol_5.24" topic="Magnetic field inside a Rowland ring"}
...
:::question{number="25" kind="additional_exercise" id="sol_5.25" topic="Classical vs quantum spin and orbital moments"}

...
$$
V_{3}=2 \times 3=6 \mathrm{~V} \ldots
$$
...
& =A_{1} l_{1} \times d_{1}=A_{1} l_{1} d_{1} \ldots
\end{aligned}
$$
...
& =A_{2} l_{2} \times d_{2}=A_{2} l_{2} d_{2} \ldots
\end{aligned}
$$
...
$$
R_{1}=1 \Omega, R_{2}=2 \Omega, R_{3}=3 \Omega 2
$$
...
(a) It can be observed from the given circuit that in the first small loop, two resistors of resistance $1 \Omega$ each are connected in series.

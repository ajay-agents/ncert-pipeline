...
:::solution
Conduction electrons drift opposite to the electric field, so they move in the direction of increasing potential. The drift speed $v_{d}$ is given by Eq. (3.18): $v_{d}=(I / n e A)$
Here, $e=1.6 \times 10^{-19} \mathrm{C}, A=1.0 \times 10^{-7} \mathrm{~m}^{2}, I=1.5 \mathrm{~A}$. We take the density of conduction electrons, $n$, equal to the number of atoms per cubic metre - reasonable, since copper's one valence electron per atom means roughly one conduction electron per atom too. A cubic metre of copper has a mass of $9.0 \times 10^{3} \mathrm{~kg}$, and $6.0 \times 10^{23}$ copper atoms have a mass of 63.5 g, so
$$
\begin{aligned}
...
:::question{number="3.15" kind="additional_exercise" id="sol_3.15" topic="Terminal voltage of series-connected secondary cells" corrections_applied="2"}

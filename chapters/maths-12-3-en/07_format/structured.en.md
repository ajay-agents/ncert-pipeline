...
:::solution{label="Solution"}
We know that a matrix of order $m \times n$ has $m n$ elements. We need to find all possible orders of a matrix with 8 elements. For this, we find all ordered pairs of natural numbers whose product is 8.
...
:::solution{label="Solution"}
:::step{label="Substitute"}
The given matrices are equal. So their corresponding elements must be equal. Comparing the corresponding elements, we get
...
:::example{number="5" kind="example" id="ex_3.5" topic="Solving for unknowns by matrix equality" corrections_applied="1"}
#### Example 5
...
:::solution{label="Solution"}
:::step{label="Substitute"}
Since the two matrices are equal, their corresponding elements must be equal. Equating them, we get
...
:::note{type="caution" label="When addition is undefined"}
- Note
...
:::note{type="recall" label="Addition as a binary operation"}
...
:::solution{label="Solution"}
(i) The combined sales in September and October, for each farmer and each variety, are given by

:::formula{label="Combined sales (A+B)"}
$$
...
(ii) The change in sales from September to October is given by

:::formula{label="Decrease in sales (A-B)"}
$$
A-B=\left[\begin{array}{ccc}
\text { Basmati } & \text { Permal } & \text { Naura } \\
5000 & 10,000 & 24,000 \\
...
:::formula{label="Profit on October sales"}
(iii) $$
\begin{aligned}
...
So, in October, Ramkishan gets ₹100, ₹200 and ₹120 as profit on each variety of rice, respectively. Gurcharan Singh gets ₹400, ₹200 and ₹200 as profit on each variety of rice, respectively.
:::
...
:::solution{label="Solution"}
The matrix A has 2 columns. This is equal to the number of rows of B. So AB is defined. Now
...
:::note{type="recall" label="AB defined does not mean BA defined"}
Remark: If AB is defined, then BA need not be defined. In the example above, AB is defined. But BA is not defined, because B has 3 columns, while A has only 2 (and not 3) rows. Suppose A and B are, respectively, $m \times n, k \times l$ matrices. Then both AB and BA are defined if and only if $n=k$ and $l=m$. In particular, if both A and B are square matrices of the same order, then both AB and BA are defined.
:::
:::
...
:::solution{label="Solution"}
A is a $2 \times 3$ matrix, and B is a $3 \times 2$ matrix. So AB and BA are both defined, and they are matrices of order 2 × 2 and 3 × 3, respectively. Note that
...
This shows that even if the product of two matrices is a zero matrix, it is not necessary that either matrix itself is a zero matrix.
:::
...
:::example{number="19" kind="example" id="ex_3.19" topic="Matrix multiplication - campaign costs" corrections_applied="3"}
#### Example 19
...
$B=\left[\begin{array}{ccc}1000 & 500 & 5000 \\ 3000 & 1000 & 10,000\end{array}\right] \begin{array}{l}\rightarrow \mathrm{X} \\ \rightarrow \mathrm{Y}\end{array}$. Find the total amount spent by the group in the two cities X and Y.
:::
...
:::example{number="21" kind="example" id="ex_3.21" topic="Transpose of a matrix product" corrections_applied="1"}
#### Example 21
...
:::step{label="Conclusion"}
Thus, B is written as the sum of a symmetric matrix and a skew symmetric matrix.
:::
:::
...
:::step{label="Inductive hypothesis"}
Next, assume the result is true for $n=k$. So
...
So the result is true for $n=k+1$. Thus, by the principle of mathematical induction, $\mathrm{A}^{n}=\left[\begin{array}{cc}\cos n \theta & \sin n \theta \\ -\sin n \theta & \cos n \theta\end{array}\right]$ holds for all natural numbers.
:::
:::
...
:::solution{label="Solution"}
A and B are both symmetric matrices. So $\mathrm{A}^{\prime}=\mathrm{A}$ and $\mathrm{B}^{\prime}=\mathrm{B}$.

:::step{n="1"}
First, suppose $\quad \mathrm{AB}$ is symmetric. Then $(\mathrm{AB})^{\prime}=\mathrm{AB}$
But
...
:::step{n="2"}
Conversely, suppose $\mathrm{AB}=\mathrm{BA}$. We now show that AB is symmetric.
Now
...
:::solution{label="Solution"}
:::concept{label="Given"}
$\mathrm{A}, \mathrm{B}, \mathrm{C}$ are all square matrices of order 2. Since $\mathrm{CD}-\mathrm{AB}$ is well defined, D must also be a square matrix of order 2.
:::
...
Solving (1) and (2) gives $a=-191, c=77$. Solving (3) and (4) gives $b=-110$, $d=44$.
:::
...
:::step{label="Conclusion"}
On comparing the corresponding elements of the two matrices, we get two different values of $x$. This is not possible.
...
:::solution{label="Solution"}
:::concept{label="Given"}
(i) Let ₹ $x$ be invested in the first bond. Then the sum invested in the second bond will be ₹ $(30000-x)$.
The first bond pays $5 \%$ interest per year, and the second bond pays $7 \%$ interest per year.
:::

:::formula{label="Key formula"}
To obtain an annual total interest of ₹1800, we have:
$$
\begin{aligned}
...
:::step{label="Conclusion"}
Thus, to obtain an annual total interest of ₹1800, the trust fund should invest ₹15000 in the first bond and the remaining ₹15000 in the second bond.
:::

:::concept{label="Given"}
(ii) Let ₹ $x$ be invested in the first bond. Then the sum invested in the second bond will be ₹ ( $30000-x)$.
:::

:::formula{label="Key formula"}
To obtain an annual total interest of ₹2000, we have:
$$
\begin{aligned}
& {[x(30000-x)]\left[\begin{array}{c}
\frac{5}{100} \\
...
:::step{label="Conclusion"}
Thus, to obtain an annual total interest of ₹1800, the trust fund should invest ₹5000 in the first bond and the remaining ₹25000 in the second bond.
:::
:::

:::

:::question{number="30" kind="exercise" id="q_3.30" topic="Matrix multiplication - bookshop revenue" corrections_applied="1"}
#### Question 30
...
:::solution{label="Solution"}
:::formula{label="Key formula"}
The total amount received from selling all these books can be written as a matrix product:
...
The number of columns in $W$ equals the number of rows in $Y$. So matrix $W Y$ is well defined and is of the order $n \times k$.
...
(ii) It is given that $B=\left[\begin{array}{lll}1 & 5 & 7\end{array}\right]$. Hence,
$$
\begin{aligned}
...
:::question{number="38" kind="exercise" id="q_3.38" topic="Verifying A'A=I for a rotation-type matrix" corrections_applied="1"}
#### Question 38
...
(iv)
:::step{n="1"}
Let $A=\left(\begin{array}{cc}1 & 5 \\ -1 & 2\end{array}\right)$
Hence,
$$
A^{\prime}=\left(\begin{array}{cc}
1 & -1 \\
...
:::solution{label="Solution"}
Let $A$ be a square matrix of order $m$. Suppose there exists another square matrix $B$ of the same order $m$, such that $A B=B A=I$. Then $B$ is said to be the inverse of $A$.
...
:::step{n="2"}
Now suppose $A$ is a skew symmetric matrix. Then
...
:::step{label="Conclusion"}
Hence, if $A$ is symmetric or skew symmetric, then $B^{\prime} A B$ is symmetric or skew symmetric accordingly.
:::
:::
...
:::solution{label="Solution"}
:::concept{label="Given"}
We are given that $A=\left(\begin{array}{cc}3 & 1 \\ -1 & 2\end{array}\right)$
:::
...
So, the total revenue in market I can be written as a matrix:
$$
\begin{aligned}
{\left[\begin{array}{lll}
10000 & 2000 & 18000
...
\end{aligned}
$$
The total revenue in market II can be written as a matrix:
$$
\begin{aligned}
{\left[\begin{array}{lll}
6000 & 20000 & 8000
...
So, the total cost of all the products in market I can be written as a matrix:
...
The total cost of all the products in market II can be written as a matrix:
...
:::question{number="53" kind="exercise" id="q_3.53" topic="Finding a matrix X from a matrix equation" corrections_applied="1"}
#### Question 53
...
:::solution{label="Solution"}
:::concept{label="Given"}
We are given that $X\left[\begin{array}{lll}1 & 2 & 3 \\ 4 & 5 & 6\end{array}\right]=\left[\begin{array}{ccc}-7 & -8 & -9 \\ 2 & 4 & 6\end{array}\right]$
The matrix on the R.H.S. of the equation is a $2 \times 3$ matrix. The one on the L.H.S. of the equation is a $2 \times 3$ matrix.

So, $X$ has to be a $2 \times 2$ matrix.
:::
...
:::question{number="54" kind="exercise" id="q_3.54" topic="MCQ - condition on alpha, beta, gamma given A^2=I" corrections_applied="1"}
#### Question 54
...
:::solution{label="Solution"}
:::concept{label="Given"}
We are given that $A=\left[\begin{array}{cc}\alpha & \beta \\ \gamma & -\alpha\end{array}\right]$
:::
...
:::solution{label="Solution"}
:::concept{label="Given"}
We are given that $A$ is a square matrix such that $A^{2}=A$.
:::
...
:::step{label="Conclusion"}
In this equation, all the entries in the second row of the matrix on the L.H.S. are zero.
...
:::step{label="Conclusion"}
In this equation, all the entries in the first row of the matrix on the L.H.S. are zero.
Thus, $A^{-1}$ does not exist.
:::
:::
...
:::question{number="EX3.OLD-16" kind="additional_exercise" id="sol_3.d.16" topic="Inverse via elementary row operations" corrections_applied="1"}
...
\frac{-3}{5} & \frac{1}{25} & \frac{9}{25}
\end{array}\right) A \\
& \Rightarrow A^{-1}=\left(R_{1} \rightarrow R_{1}+3 R_{3} \text { and } R_{2} \rightarrow R_{2}+8 R_{3}\right) \\
...
:::solution{label="Solution"}
:::concept{label="Given"}
We are given that $A=\left(\begin{array}{ll}0 & 1 \\ 0 & 0\end{array}\right)$
:::

We will prove the result using the principle of mathematical induction.
...
:::solution{label="Solution"}
:::concept{label="Given"}
We are given that $A=\left(\begin{array}{ll}3 & -4 \\ 1 & -1\end{array}\right)$
:::
...
:::question{number="MISC-12" kind="additional_exercise" id="sol_3.misc.12" topic="Commuting matrices and induction" corrections_applied="1"}
...
:::step{n="2"}
Now we prove that $(A B)^{n}=A^{n} B^{n}$ for all $n \in N$

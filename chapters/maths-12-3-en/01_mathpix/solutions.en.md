...
(ii) $\quad\left(\begin{array}{cc}x+y & 2 \\ 5+z & x y\end{array}\right)=\left(\begin{array}{ll}6 & 2 \\ 5 & 8\end{array}\right)$
...
Question 8:
$A=\left[a_{i j}\right]_{m \times n}$ is a square matrix, if
(A) $m<n$
(B) $m>n$
(C) $m=n$
(D) None of these
...
Question 1:
Let $A=\left[\begin{array}{ll}2 & 4 \\ 3 & 2\end{array}\right], B=\left[\begin{array}{cc}1 & 3 \\ -2 & 5\end{array}\right], C=\left[\begin{array}{cc}-2 & 5 \\ 3 & 4\end{array}\right]$. Find each of the following:
...
(i) $\quad\left(\begin{array}{cc}a & b \\ -b & a\end{array}\right)+\left(\begin{array}{ll}a & b \\ b & a\end{array}\right)$
(ii) $\quad\left(\begin{array}{ll}a^{2}+b^{2} & b^{2}+c^{2} \\ a^{2}+c^{2} & a^{2}+b^{2}\end{array}\right)+\left(\begin{array}{cc}2 a b & 2 b c \\ -2 a c & -2 a b\end{array}\right)$
(iii) $\quad\left(\begin{array}{ccc}-1 & 4 & -6 \\ 8 & 5 & 16 \\ 2 & 8 & 5\end{array}\right)+\left(\begin{array}{ccc}12 & 7 & 6 \\ 8 & 0 & 5 \\ 3 & 2 & 4\end{array}\right)$
...
(iii) $\quad\left(\begin{array}{cc}1 & -2 \\ 2 & 3\end{array}\right)\left(\begin{array}{lll}1 & 2 & 3 \\ 2 & 3 & 1\end{array}\right)$
...
0 & 3 & 2 \\
1 & -2 & 3
\end{array}\right), \text { then compute }(A+B) \text { and }(B-C) . \text { Also, }
$$
...
Question 5:
$A=\left(\begin{array}{ccc}\frac{2}{3} & 1 & \frac{5}{3} \\ \frac{1}{3} & \frac{2}{3} & \frac{4}{3} \\ \frac{7}{3} & 2 & \frac{2}{3}\end{array}\right)$ and $B=\left(\begin{array}{ccc}\frac{2}{5} & \frac{3}{5} & 1 \\ \frac{1}{5} & \frac{2}{5} & \frac{4}{5} \\ \frac{7}{5} & \frac{6}{5} & \frac{2}{5}\end{array}\right)$, then compute $3 A-5 B$.
Solution:
...
Question 7:
Find $X$ and $Y$, if
(i) $\quad X+Y=\left(\begin{array}{ll}7 & 0 \\ 2 & 5\end{array}\right)$ and $X-Y=\left(\begin{array}{ll}3 & 0 \\ 0 & 3\end{array}\right)$

(ii) $2 X+3 Y=\left(\begin{array}{ll}2 & 3 \\ 4 & 0\end{array}\right)$ and $3 X+2 Y=\left(\begin{array}{cc}2 & -2 \\ -1 & 5\end{array}\right)$
...
Question 10:
Solve the equation for $x, y, z$ and $t$ if $2\left(\begin{array}{cc}x & z \\ y & t\end{array}\right)+3\left(\begin{array}{cc}1 & -1 \\ 0 & 2\end{array}\right)=3\left(\begin{array}{ll}3 & 5 \\ 4 & 6\end{array}\right)$.
Solution:
...
$$
\text { Given } 3\left(\begin{array}{ll}
x & y \\
z & w
\end{array}\right)=\left(\begin{array}{cc}
x & 6 \\
...
4 & x+y \\
z+w & 3
\end{array}\right) \text {, find values of } w, x, y \text { and } z \text {. }
$$
...
\sin x & \cos x & 0 \\
0 & 0 & 1
\end{array}\right), \text { show that } F(x) F(y)=F(x+y) .
$$
...
Question 16:
$A=\left(\begin{array}{lll}1 & 0 & 2 \\ 0 & 2 & 1 \\ 2 & 0 & 3\end{array}\right)$, prove that $A^{3}-6 A^{2}+7 A+2 I=0$.
...
and $I$ is the identity matrix of order ${ }^{2}$, show that $I+A=(I-A)\left(\begin{array}{cc}\cos \alpha & -\sin \alpha \\ \sin \alpha & \cos \alpha\end{array}\right)$
...
(ii) $\quad\left(\begin{array}{cc}1 & -1 \\ 2 & 3\end{array}\right)$
...
\cos \alpha & \sin \alpha \\
-\sin \alpha & \cos \alpha
\end{array}\right), \text { then verify } A^{\prime} A=I
$$
(ii) $$
A=\left(\begin{array}{cc}
\sin \alpha & \cos \alpha \\
...
x & y & -z \\
x & -y & z
\end{array}\right) \text { satisfy the equation } A^{\prime} A=I .
$$
...
Question 8:
If $A=\left(\begin{array}{cc}3 & 1 \\ -1 & 2\end{array}\right)$, show that $A^{2}-5 A+7 I=0$
Solution:
